...
const ShopContextProvider = (props) => {
    ...
    const addToCart = async (itemId, size, buttonElement = null) => {
    ...
    return (
        <ShopContext.Provider value={value}>
            {props.children}
            <BubblePopup 
                show={bubblePopup.show}
                onClose={() => setBubblePopup({ show: false, position: { x: 0, y: 0 }, message: '' })}
                message={bubblePopup.message}
                position={bubblePopup.position}
            />
